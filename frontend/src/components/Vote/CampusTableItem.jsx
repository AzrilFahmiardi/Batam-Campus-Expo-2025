    ...
    <tr>
      ...
      <td className="whitespace-nowrap bg-white p-2 font-montserrat sm:p-3 md:px-4 md:py-2">
        <div className="flex w-full items-center gap-2 sm:gap-3">
          ...
          <p className="flex-1 text-[10px] sm:text-base md:text-lg">{name}</p>
        </div>
      </td>

      <td className="w-[75px] rounded-r-xl bg-white p-2 text-center font-montserrat text-[10px] font-semibold sm:w-[110px] sm:p-3 sm:text-sm md:w-[120px] md:px-2 md:py-2 md:text-lg lg:w-[150px] lg:text-xl">
        {vote} Vote
      </td>
    </tr>
  );
