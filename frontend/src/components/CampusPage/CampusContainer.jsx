...
const CampusContainer = () => {
    ...
    useEffect(() => {
      ...
      return(
        <section className="relative flex h-auto flex-col items-center justify-start overflow-hidden py-10 text-center bg-campus-page-background-gradient sm:py-14 md:py-16 lg:py-20 xl:py-24">
            <img
