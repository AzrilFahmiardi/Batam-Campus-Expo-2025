...
const Location = () => {
  return (
    <div className="relative space-y-8 overflow-hidden p-5 px-11 md:space-y-16 md:py-20">
      ...
      />
      <p className="text bg-orange-red-gradient bg-clip-text text-center font-pixelify text-3xl font-bold text-transparent md:text-5xl">
        Event Location
      ...
      <div className="grid grid-rows-2 place-items-center gap-5 md:grid-cols-2 md:grid-rows-1 md:gap-10">
        <Maps
          mapUrl={
