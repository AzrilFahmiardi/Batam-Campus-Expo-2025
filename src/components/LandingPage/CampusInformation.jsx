...
const CampusInformation = () => {
  return (
    <div className="relative space-y-10 px-10 py-20">
      <img
        src={CloudCampusInformation}
        className="absolute right-0 top-36 w-[20%]"
      />
      <img
      ...
      <div className="grid place-items-center px-10">
        <div className="detailed-pixel-border -z-20 mx-auto bg-white px-20 py-10 shadow-2xl md:px-28">
